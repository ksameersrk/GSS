...
public class PauseTest0{
    ...
    public static void main(String[] args) throws Exception {
        ...
        DatacenterBrokerEX broker = new DatacenterBrokerEX("Broker", CloudSim.lifeLength);
        ...
        broker.destroyVMsAfter(Arrays.asList(vm), CloudSim.lifeLength);
        ...
        Cloudlet cloudlet_1 = new Cloudlet(id + 1, length, pesNumber, fileSize, outputSize, utilizationModel,
                utilizationModel, utilizationModel);
        cloudlet_1.setUserId(broker.getId());
        cloudlet_1.setVmId(vmid);
        broker.submitCloudletList(Arrays.asList(cloudlet_1), 30);
