...
public class StagingDiskRingAndSpinDown {
...
//        }
        ...
        if (addStagingDisk == false) {
            ...
            stagingDiskSimulate(arrivalFile, dataFile, requiredFile, updateFile, deleteFile, inputLog, nodeToTaskMapping, nodeList,
                    noOfActiveAlwaysDisks, ringOfActiveAlwaysDisks, noOfSpunDownDisks, ringOfSpunDownDisks, stagingDiskRing);
