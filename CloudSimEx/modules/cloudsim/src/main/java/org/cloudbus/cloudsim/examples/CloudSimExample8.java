 ...
 * Simulation of Clouds Licence: GPL - http://www.gnu.org/copyleft/gpl.html Copyright (c) 2009, The
 ...
 * run-time using a globar manager entity (GlobalBroker).
 */
public class CloudSimExample8 {
	...
	private static Datacenter createDatacenter(String name) {
		...
		hostList.add(new Host(hostId, new RamProvisionerSimple(ram), new BwProvisionerSimple(bw), storage,
				peList2, new VmSchedulerTimeShared(peList2))); // Second machine
