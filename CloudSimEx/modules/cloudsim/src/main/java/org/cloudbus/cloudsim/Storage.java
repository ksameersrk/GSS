...
/**
 * An interface which defines the desired functionality of a storage system in a Data Cloud. The classes that implement
 * this interface should simulate the characteristics of different storage systems by setting the capacity of the
 * storage and the maximum transfer rate. The transfer rate defines the time required to execute some common operations
 * on the storage, e.g. storing a file, getting a file and deleting a file.
 *
 * @author Uros Cibej
...
public interface Storage {
	...
	/**
	 * Gets the space used by of the storage in MByte.
	 *
	 * @return the space used of the storage in MB
	 */
	double getUsedSpace(); // Name changed by Baptiste Louis
	 ...
	 */
	double getMaxInternalDataTransferRate(); // Name changed by Baptiste Louis
	 ...
	 */
	// boolean setMaxTransferRate(int rate); // removed by Baptiste Louis

	/**
	 * Gets the free space on this storage in MByte.
	 *
	 * @return the free space in MB
	 */
	double getFreeSpace(); // Name changed by Baptiste Louis
	...
	/**
	 * Adds a file for which the space has already been reserved. The time taken (in seconds) for adding the specified
	...
	/**
	 * Adds a file to the storage. The time taken (in seconds) for adding the specified file can also be found using
	...
	/**
	 * Adds a set of files to the storage. The time taken (in seconds) for adding each file can also be found using
	 * {@link gridsim.datagrid.File#getTransactionTime()}.
	 *
	 * @param list
	...
	/**
	 * Removes a file from the storage. The time taken (in seconds) for deleting the specified file can be found using
	 * {@link gridsim.datagrid.File#getTransactionTime()}.
	 *
	 * @param fileName
	...
	/**
	 * Removes a file from the storage. The time taken (in seconds) for deleting the specified file can also be found
	 * using {@link gridsim.datagrid.File#getTransactionTime()}.
	 *
	 * @param fileName
	 *            the name of the file to be removed
	 * @param file
	...
	/**
	 * Renames a file on the storage. The time taken (in seconds) for renaming the specified file can also be found
	 * using {@link gridsim.datagrid.File#getTransactionTime()}.
	 *
	 * @param file
